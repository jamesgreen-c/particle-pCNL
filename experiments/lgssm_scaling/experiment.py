...
def one_experiment(key):
    ...
    return esjd_vals.mean(0), true_xs, init_xs
...
for k, key_k in enumerate(tqdm.tqdm(EXPERIMENT_KEYS, desc="Experiment: ")):
    esjd_k, true_xs, init_xs = one_experiment(key_k)
    esjd_all[k] = esjd_k

    # print("True xs shape ", true_xs.shape)
    # print("Init xs shape ", init_xs.shape)
    if args.plot:
